...
; developed by Bo Brant閚 <bosse@acc.umu.se> in 2020 to help beta testing.
;
...
DirText "This is a beta release of the ${PROJECTNAME} project from Bo Brant閚 to test the new ext4 features metadata checksums and 64-bit block numbers. You may choose the install directory:"
